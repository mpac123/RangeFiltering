#ifndef RANGE_FILTERING_SPLASH_LOUDS_DENSE_HPP
#define RANGE_FILTERING_SPLASH_LOUDS_DENSE_HPP
...
namespace range_filtering_splash {
    ...
    public:
        LoudsDense() {};
        LoudsDense(const SplashBuilder* builder);
    ...
    LoudsDense::LoudsDense(const SplashBuilder* builder) {
