#ifndef RANGE_FILTERING_LOUDS_DENSE_HPP
#define RANGE_FILTERING_LOUDS_DENSE_HPP
...
namespace range_filtering {
    ...
    public:
        LoudsDense() {};
        LoudsDense(const FSTBuilder* builder);
    ...
    LoudsDense::LoudsDense(const FSTBuilder* builder) {
