#ifndef FST_BUILDER_H_
#define FST_BUILDER_H_
...
namespace range_filtering {
    ...
    level_t FSTBuilder::insertKeyBytesToTrie(const std::string& key, const std::string& next_key, const level_t start_level) {
    ...
    inline void FSTBuilder::storeSuffix(const level_t level, const word_t suffix) {
