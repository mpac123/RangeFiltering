...
namespace range_filtering {
    ...
    class CHaREQUnitTest : public ::testing::Test {
        ...
        TEST_F(CHaREQUnitTest, denseChareq) {
            std::vector<std::string> keys = {
                    "fab",
                    "far",
                    "fast",
        ...
        TEST_F (CHaREQUnitTest, lookupRangeWordTest) {
            auto filter = new CHaREQ(words, 0.2);
...
int main (int argc, char** argv) {
    ...
    range_filtering::chareq_test::loadWordList();
