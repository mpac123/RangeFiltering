#ifndef RANGE_FILTERING_BLOOMED_SPLASH_LOUDS_DENSE_HPP
#define RANGE_FILTERING_BLOOMED_SPLASH_LOUDS_DENSE_HPP
...
namespace range_filtering_bloomed_splash {
    ...
    public:
        LoudsDense() {};
        LoudsDense(const BloomedSplashBuilder* builder);
    ...
    LoudsDense::LoudsDense(const BloomedSplashBuilder* builder) {
...
#endif //RANGE_FILTERING_LOUDS_DENSE_HPP
