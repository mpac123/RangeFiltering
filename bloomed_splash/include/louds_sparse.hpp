#ifndef RANGE_FILTERING_BLOOMED_SPLASH_LOUDS_SPARSE_HPP
#define RANGE_FILTERING_BLOOMED_SPLASH_LOUDS_SPARSE_HPP
...
namespace range_filtering_bloomed_splash {
    ...
    public:
        LoudsSparse() {};
        LoudsSparse(const BloomedSplashBuilder* builder);
    ...
    LoudsSparse::LoudsSparse(const BloomedSplashBuilder* builder) {
