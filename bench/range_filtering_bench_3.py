...
# dir="50k_10_10_2__2_50"
results_dir = "range-filtering-results/100k_26_15_3__surf_suffix_type"
...
for a, b in ranges:
    for qt in querytypes:
        ...
        with open(results_dir + "/" + str(a) + "_" + str(b) + "_" + qt + ".txt", "w") as f:
            df.to_csv(f)