#ifndef RANGE_FILTERING_BLOOMED_RANGE_SPLASH_LOUDS_SPARSE_HPP
#define RANGE_FILTERING_BLOOMED_RANGE_SPLASH_LOUDS_SPARSE_HPP
...
namespace range_filtering_bloomed_range_splash {
    ...
    public:
        LoudsSparse() {};
        LoudsSparse(const BloomedSplashRangeBuilder* builder);
    ...
    LoudsSparse::LoudsSparse(const BloomedSplashRangeBuilder* builder) {
        ...
        // There are no suffixes in BloomedSplash
...
#endif //RANGE_FILTERING_BLOOMED_RANGE_SPLASH_LOUDS_SPARSE_HPP
