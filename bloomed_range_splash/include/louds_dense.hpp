#ifndef RANGE_FILTERING_BLOOMED_RANGE_SPLASH_LOUDS_DENSE_HPP
#define RANGE_FILTERING_BLOOMED_RANGE_SPLASH_LOUDS_DENSE_HPP
...
namespace range_filtering_bloomed_range_splash {
    ...
    public:
        LoudsDense() {};
        LoudsDense(const range_filtering_bloomed_range_splash::BloomedSplashRangeBuilder* builder);
        ...
        static LoudsDense* deSerialize(char*& src) {
            ...
            align(src);
            louds_dense->label_bitmaps_ = surf::BitvectorRank::deSerialize(src);
            louds_dense->child_indicator_bitmaps_ = surf::BitvectorRank::deSerialize(src);
            louds_dense->prefixkey_indicator_bits_ = surf::BitvectorRank::deSerialize(src);
            louds_dense->suffixes_ = surf::BitvectorSuffix::deSerialize(src);
            align(src);
            return louds_dense;
        }
    ...
    private:
        ...
        surf::BitvectorRank* label_bitmaps_;
        surf::BitvectorRank* child_indicator_bitmaps_;
        surf::BitvectorRank* prefixkey_indicator_bits_; //1 bit per internal node
        surf::BitvectorSuffix* suffixes_;
    };


    LoudsDense::LoudsDense(const BloomedSplashRangeBuilder* builder) {
        ...
        label_bitmaps_ = new surf::BitvectorRank(kRankBasicBlockSize, builder->getBitmapLabels(),
                                                 num_bits_per_level, 0, height_);
        child_indicator_bitmaps_ = new surf::BitvectorRank(kRankBasicBlockSize,
                                                           builder->getBitmapChildIndicatorBits(),
                                                           num_bits_per_level, 0, height_);
        prefixkey_indicator_bits_ = new surf::BitvectorRank(kRankBasicBlockSize,
...
#endif //RANGE_FILTERING_BLOOMED_RANGE_SPLASH_LOUDS_DENSE_HPP
