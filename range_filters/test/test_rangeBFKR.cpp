...
namespace range_filtering {
    namespace range_bf_kr_test {
        static const std::string kFilePath = "/home/mapac/Coding/RangeFiltering/succinct_trie/test/words.txt";
        static std::vector<std::string> words;
        static const int kWordTestSize = 234369;
        class RangeBfKRUnitTest : public ::testing::Test {

        };

        TEST_F(RangeBfKRUnitTest, emptyKeysSet) {
            auto keys = std::vector<std::string>();
            auto filter = RangeBFKR(keys, 5000);
        ...
        TEST_F(RangeBfKRUnitTest, simpleKeysSet) {
            ...
            auto trie = RangeBFKR(keys, 50000);
        ...
        TEST_F (RangeBfKRUnitTest, lookupRangeWordTest) {
            auto rosetta = new RangeBFKR(words, 100000);
...
int main (int argc, char** argv) {
    ...
    range_filtering::range_bf_kr_test::loadWordList();
