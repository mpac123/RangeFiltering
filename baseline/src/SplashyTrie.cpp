...
namespace range_filtering {
    ...
    unsigned long long SplashyTrie::TrieNode::getMemoryUsage() const {
    ...
    unsigned long long SplashyTrie::TrieNode::getChildrenMemoryUsage() const {
    ...
    unsigned long long SplashyTrie::LeafNode::getMemoryUsage() const {
    ...
    unsigned long long SplashyTrie::getMemoryUsage() const {
