...
namespace range_filtering {
    ...
    uint64_t BloomedSurfingTrie::TrieNode::getMemoryUsage() const {
    ...
    uint64_t BloomedSurfingTrie::TrieNode::getChildrenMemoryUsage() const {
    ...
    uint64_t BloomedSurfingTrie::LeafNode::getMemoryUsage() const {
...
//        }
    ...
    uint64_t BloomedSurfingTrie::getMemoryUsage() const {
